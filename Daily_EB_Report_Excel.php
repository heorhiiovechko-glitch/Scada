           	...
           	<td width="100%">
           		<table width="100%" border="<?= $XLS == 1 ? "1" : "0" ?>" align="left" cellpadding="1" cellspacing="1" class="innertab1">
           			...
           			<?php
						...
						?>
           				<tr>
           					<td class="tab-head-tr" colspan="8" align="left">&nbsp;&nbsp;<b>Daily EB Slot Report-LCS</b></td>
           				</tr>
           			<?php
						}
						?>
           			...
           			<?php
						...
						if (isset($_REQUEST['p']) && ($_REQUEST['p'] == 6 || $_REQUEST['p'] == 61)) {
							...
							foreach ($Date_Range as $Date_Range_Val) {
								...
								foreach ($PAT_Total_24_Merge[$DRVF] as $PAT_Total_24_Merge_Key => $PAT_Total_24_Merge_Val) {
									...
									if ($PAT_Total_24_Merge_Prev == '') {
										$PAT_Total_24_Merge_Prev = $PAT_Total_RI[$DRVF][1]; //3257920
									}
									...
									$PAT_Total_Next[$DRVF] = $PAT_Total[$DRVF][$PAT_Total_Next1[$DRVF]];
								...
								//	$PAT_Total_22_24[$DRVF] = $PT_EB_Fl[$DRVF]['k24']['Curr']."--".$PT_EB_Fl[$DRVF]['k22']['Curr']."--";
								//	$PAT_Total_00_05[$DRVF] = $PT_EB_Fl[$DRVF]['k05']['Curr']."--".$PT_EB_Fl[$DRVF]['k00']['Curr']."--";


								//$STotal_Daily[$DRVF] = $PAT_Total_06_09[$DRVF] ."--". $PAT_Total_18_21[$DRVF] ."--". //$PAT_Total_09_18[$DRVF]."--". $PAT_Total_05_06[$DRVF]."--".   $PAT_Total_00_05[$DRVF] ."--".  $PAT_Total_22_24[$DRVF];
							?>
           				<?php
								$MI++;
							}
