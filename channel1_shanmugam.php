...
$Mysql_Query2 = "SELECT  t1.IMEI,t1.Format_Type,t1.State,t1.Site_Location,t1.Account_ID,t1.Parent_ID,t1.Device_Order,t1.Device_Index,
								...
								FROM device_register AS t1 
 								 LEFT JOIN
						            ...
						            SELECT Device_Index,State, COUNT(State)  totalCount
           							 FROM device_register where Device_Index in (5,2) GROUP   BY Region
       					 )  s ON s.State = t1.State where t1.Device_Index in (5,2) group by IMEI   
            ...
            <div class="grid">
                ...
                if ($queryResult2->num_rows >= 1) {
                    ...
                    while ($Fetch_Result = $queryResult2->fetch_array()) {
						...
						$Database_Name = $Fetch_Result['db_name'] ;
						...
						// choose the correct latest-record query (preserved)
                       else if ($Format_Type == 11){
							if ($Database_Name == 'va_powercon') 
							{
                                $Mysql_Query1 = "select Date_F as Date_S, Time_F as Time_S, Bridge1_dcv as WindSpeed, Bridge2_dcc as Power, status as Status, Phase2_kvar AS G1 from va_powercon.device_data_f11 where IMEI = '" . $IMEI_Decode . "' order by Record_Index desc limit 1";
                        ...
                        if ($queryResult1->num_rows >= 0) {
							...
							"&l=" . $Pocket_Length .
							"&FType=" . $Format_Type .
							"&ACC=" . $Fetch_Result['Account_ID'] .
							"&DB=" . $Fetch_Result['db_name'] .
							"&Cap=" . $Fetch_Result['Capacity'] .
							"&Dev=" . urlencode($Fetch_Result['Device_Name']) .
							"&State=" . urlencode($Fetch_Result['State']) .
							"&Loc=" . urlencode($Fetch_Result['Site_Location']);
        ...
        <div class="right-values">
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td class="value"><?= htmlspecialchars("105019") ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><?= htmlspecialchars("Karnataka") ?></td>
                </tr>
                <tr>
