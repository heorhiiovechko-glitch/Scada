...
">
	...
	<div style="font-size:40px; font-weight:800;">
		<a style="font-size:20px; font-weight:600;" href="channel2_ajax.php?c1=<?php echo urlencode($_REQUEST['c1']); ?>&l=<?php echo urlencode($_REQUEST['l']); ?>&FType=<?php echo urlencode($_REQUEST['FType']); ?>">Reports</a>
	</div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php if ($Cook_Variable[3]!='100133') { ?>
                                <th>Power Fact</th><th>Freq</th><th>Ambt</th><th>Nacel</th><th>Gear</th><th>Gen1</th>
                                <th>Bear</th><th>Cntrl</th><th>Hydr</th><th>Gen0 Kwh</th><th>Gen1 Kwh</th><th>Total Kwh</th>
	...
	<div class="material-card" style="margin-top:20px;">
		...
		<div class="section-header">Daily Generation Report
			<iframe class="responsive-iframe" src="Daily_Generation_Report_Individual_Excel_iframe.php?c1=<?php echo urlencode($_REQUEST['c1']); ?>&l=<?php echo urlencode($_REQUEST['l']); ?>&FType=<?php echo urlencode($_REQUEST['FType']); ?>" class="iframe">
			</iframe>
		</div>
	</div>
</div>
