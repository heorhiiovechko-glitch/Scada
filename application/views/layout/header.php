    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
            ...
            <div class="sidebar">
                <nav class="sidebar-nav">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-size:18px;"    href="<?php echo base_url() . 'dashboard/park_view'; ?>">
        ...
        <?php foreach ($sub as $key1 => $val) { ?>
            ...
            <?php foreach ($val as $device) { ?>
                                                                <li class="nav-item">
                                                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/device_details?id=' . $device['IMEI'] . '&type=' . $device['Format_Type']; ?>"    >
...
?>
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/tempAnalysis'; ?>">
                                        <i class="fa fa-area-chart"></i> Temperature</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/powercurve_analysis'; ?>">
                                        <i class="fa fa-area-chart"></i> Power Curve</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/performance_analysis'; ?>">
                                        <i class="fa fa-area-chart"></i> Performance</a>
                                </li>
								 <li class="nav-item">
                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/perfomance_chart'; ?>">
                                        <i class="fa fa-area-chart"></i> Heat Map </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item nav-dropdown">
                            <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/reports'; ?>">
                                <i class="nav-icon icon-cursor"></i> Reports</a>
                           <!-- <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/power_windspeed_report'; ?>">
                        ...
                        <!--<li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                               ...
                               <li class="nav-item">
                                    <a class="nav-link"    style="font-size:18px;" href="<?php echo base_url() . 'dashboard/export_gad'; ?>">
