...
?>
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank" href="<?php echo base_url() . 'dashboard/perfomance_chart'; ?>">
                                        <i class="fa fa-area-chart"></i> Performance Trending Chart </a>
                                </li>
                               <li class="nav-item">
                                    <a class="nav-link" target="_blank" href="<?php echo base_url() . 'dashboard/export_gad'; ?>">
