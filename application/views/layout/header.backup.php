    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" style="font-size:18px;" href="<?php echo base_url() . 'logout'; ?>">
                    ...
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link">
                                ...
                                <span style="font-size:16px;"><?php echo $this->session->userdata('username'); ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size:18px;" href="<?php echo base_url() . 'dashboard'; ?>">
                                <i class="nav-icon icon-drop"></i> Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size:18px;" target="_blank" href="<?php echo base_url() . 'dashboard/park_view'; ?>">
                                <i class="nav-icon icon-pencil"></i> Park View</a>
                        </li>
                        <li class="nav-item nav-dropdown">
                            <a class="nav-link nav-dropdown-toggle" style="font-size:18px;" href="#">
        ...
        <?php foreach ($sub as $key1 => $val) { ?>
            ...
            <?php foreach ($val as $device) { ?>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/device_details?id=' . $device['IMEI'] . '&type=' . $device['Format_Type']; ?>"  target="_blank">
...
?>
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/tempAnalysis'; ?>">
                                        <i class="fa fa-area-chart"></i> Temperature</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/powercurve_analysis'; ?>">
                                        <i class="fa fa-area-chart"></i> Power Curve</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/performance_analysis'; ?>">
                                        <i class="fa fa-area-chart"></i> Performance</a>
                                </li>
								 <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/perfomance_chart'; ?>">
                                        <i class="fa fa-area-chart"></i> Heat Map </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item nav-dropdown">
                            <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/reports'; ?>">
                                <i class="nav-icon icon-cursor"></i> Reports</a>
                           <!-- <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/power_windspeed_report'; ?>">
                        ...
                        <!--<li class="nav-item nav-dropdown">
                            <a class="nav-link nav-dropdown-toggle" style="font-size:18px;" href="#">
                                <i class="nav-icon icon-cursor"></i> Graph</a>
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/perfomance_chart'; ?>">
                                        <i class="fa fa-area-chart"></i> Heat Map </a>
                               ...
                               <li class="nav-item">
                                    <a class="nav-link" target="_blank" style="font-size:18px;" href="<?php echo base_url() . 'dashboard/export_gad'; ?>">
                                        <i class="fa fa-area-chart"></i> Export GAD </a>
                                </li>
                            </ul>
                        </li>-->
                        <li class="divider"></li>
                        ...
                        <!--<li class="nav-item px-3 d-compact-none d-minimized-none">
                            <div class="text-uppercase mb-1" style="font-size:18px;">
                                <small>
                                    <b>Avg Wind Speed</b>
                                </small>
                            </div>
