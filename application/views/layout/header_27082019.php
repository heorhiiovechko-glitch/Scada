    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
        ...
        <?php foreach ($sub as $key1 => $val) { ?>
            ...
            <?php foreach ($val as $device) { ?>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="<?php echo base_url() . 'dashboard/device_details?id=' . $device['IMEI'] . '&type=' . $device['Format_Type']; ?>"  target="_blank">
...
?>
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url() . 'dashboard/performance_analysis'; ?>">
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url() . 'dashboard/power_windspeed_report'; ?>">
