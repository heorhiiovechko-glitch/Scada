								...
								FROM device_register AS t1 
 								 LEFT JOIN
						            ...
						            SELECT Device_Index,State, COUNT(State)  totalCount
           							 FROM  device_register where Device_Index not in ('582','583','584','585','586','587','588','589','591','592','1002','1003','1004','1005','1006','1007','735','761','837','825','826','827','840','843','844','969','983','984','985','719','974','977','978','979','1020','1022','1008','611','845','949','950','1084','1085','169','730','731','732','529','89','640','363','1028','1029','634','635','636','637','638','697','819','428','431','1093','653','493','689','181','423','1037','520','865','871','866','868','869','867','664','665','429','402','649','1018','1019','1021','541','663','694','571','597','828','830','675','814','990','451','848','641','642','643','644','645','646','647','648','609','603','604','815','1057','1058','1059','1060','1061','1062','1063','1064','1065','1066','1067','1068','1069','1070','1071','1072','1073','1074','1075','1076','1077','1078','1079','1080','1091','915','918','920','927','930','864','734','749','750','751','991','992','993','994','1135','1138','996','958','682','1131','1141','1142','1143','1144','1145','1146','1147','1113','1117','666','667','672','673','674','783''793','1092','1193','1265','1266','1169','1170','1171','1172','1173','1174','1175','1176','1180','1181','177','1192','776','777','784','389','595','1220','1221','1222','1223','1225','1257','1258','1259','1129','1086','980','1035','1036','1118','1326','1308','1309') GROUP   BY Region
       					 )  s ON s.State = t1.State where t1.Device_Index not in ('582','583','584','585','586','587','588','589','591','592','1002','1003','1004','1005','1006','1007','735','761','837','825','826','827','840','843','844','969','983','984','985','719','974','977','978','979','1020','1022','1008','611','845','949','950','1084','1085','169','730','731','732','529','89','640','363','1028','1029','634','635','636','637','638','697','819','428','431','1093','653','493','689','181','423','1037','520','865','871','866','868','869','867','664','665','429','402','649','1018','1019','1021','541','663','694','571','597','828','830','675','814','990','451','848','641','642','643','644','645','646','647','648','609','603','604','815','1057','1058','1059','1060','1061','1062','1063','1064','1065','1066','1067','1068','1069','1070','1071','1072','1073','1074','1075','1076','1077','1078','1079','1080','1091','915','918','920','927','930','864','734','749','750','751','991','992','993','994','1135','1138','996','958','682','1131','1141','1142','1143','1144','1145','1146','1147','1113','1117','666','667','672','673','674','783','793','1092','1193','1265','1266','1169','1170','1171','1172','1173','1174','1175','1176','1180','1181','177','1192','776','777','784','389','595','1220','1221','1222','1223','1225','1257','1258','1259','1129','1086','980','1035','1036','1118','1326','1308','1309') group by IMEI   
	...
	//$Mysql_Query = "SELECT  IMEI,Format_Type,State,Site_Location,Account_ID,Parent_ID,Device_Order,Device_Index,HTSC_No,WEG_No,Device_Name,Pocket_Length,db_name,Power_Curve,Connect_Feeder FROM  device_register where device_index not in ('550','551','552','601') group by IMEI ORDER   BY State desc,db_name asc,device_order asc";
            ...
            if($queryResult->num_rows >= 1)
            {
                while($Fetch_Result = $queryResult->fetch_array()) {
									...
									if($Format_Type == 1){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type1/$IMEI_Org.txt";
										$Table_Name = "device_data"; 
										$Error_Table_Name = "error_data"; 
									}elseif($Format_Type == 2){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type2/$IMEI_Org.txt";
										$Table_Name ="device_data_f2";									
										$Error_Table_Name = "error_data_f2"; 
									}elseif($Format_Type == 3){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type3/$IMEI_Org.txt";
										$Table_Name = "device_data_f3";									
										$Error_Table_Name = "error_data_f3";
									}elseif($Format_Type == 4){
										$Channel_Url =  "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type4/$IMEI_Org.txt";
										$Table_Name = "device_data_f4";									
										$Error_Table_Name = "error_data_f4";
									}elseif($Format_Type == 5){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type5/$IMEI_Org.txt";
										$Table_Name = "device_data_f5"; 
										$Error_Table_Name = "error_data_f5"; 
									}elseif($Format_Type == 6){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type6/$IMEI_Org.txt";
										$Table_Name = "device_data_f6"; 
										$Error_Table_Name = "error_data_f6"; 
									}elseif($Format_Type == 7){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type7/$IMEI_Org.txt";
										$Table_Name = "device_data_f7"; 
										$Error_Table_Name = "error_data_f7"; 
									}elseif($Format_Type == 8){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type8/$IMEI_Org.txt";
										$Table_Name = "device_data_f8"; 
										 $Error_Table_Name = "error_data_f8";
									}elseif($Format_Type == 9){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type9/$IMEI_Org.txt";
										$Table_Name = "device_data_f9"; 
										 $Error_Table_Name = "error_data_f9";
									}elseif($Format_Type == 10){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type10/$IMEI_Org.txt";
										$Table_Name = "device_data_f10"; 
										 $Error_Table_Name = "error_data_f10"; 
									}elseif($Format_Type == 11){
										$Channel_Url = "http://166.62.35.48:90/versatile_log/EventLog/$Cur_Date/Type11/$IMEI_Org.txt";
