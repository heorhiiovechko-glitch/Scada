...
?>
 <script type="text/javascript">
    ...
    function my_function(){
      $('#getdata').load('channel.php #getdata');
    }
										...
										else
										{
											...
											if(in_array($Status,$Error_Array['Green'])){
												...
												if($Power == '000' || $Power == '0' || $Power < 0){
													...
													$WTG_Run++;
													/*$Tower_Img = '<script type="text/javascript">startIeFix();</script>
													<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
													  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0"

													  id="name" width="100px" height="100px">
													  <param name="movie" value="http://166.62.35.48:8080/versatilescada.com/images/Orange.swf">
													  <param name="quality" value="high">
													  <param name="wmode" value="transparent">
													  <embed name="name" src="http://166.62.35.48:8080/versatilescada.com/images/Orange.swf"
													  quality="high" wmode="transparent" width="100px" height="100px"
...
$Tower_Img = '<img src="./images/7.gif" width="69px" height="98px" alt="orange Tower">';
													...
													<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
													  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0"
													  id="name" width="100px" height="100px">
													  <param name="movie" value="http://166.62.35.48:8080/versatilescada.com/images/Green.swf">
													  <param name="quality" value="high">
													  <param name="wmode" value="transparent">
													  <embed name="name" src="http://166.62.35.48:8080/versatilescada.com/images/Green.swf"
													  quality="high" wmode="transparent" width="100px" height="100px"
													  type="application/x-shockwave-flash" 
													pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?
													P1_Prod_Version=ShockwaveFlash">
													...
													<script type="text/javascript">endIeFix();</script>													';*/
$Tower_Img = '<img src="./images/6.gif" width="69px" height="98px" alt="Green Tower">';
                                   ...
                                   <?= $Connect_Feeder[$Site_Location["$IMEI_Decode"]]?>
                                        <table border="0" cellpadding="0" cellspacing="0" style="border:solid 2px #009999;" width="206px" height="260px">
                                            <tr>
												...
												<?php if ($Account_ID!='100146') {?> <a target="_blank" href="<?=$Channel_Url?>c1=<?=$IMEI?>&l=<?=$Pocket_Length?>&FType=<?=$Format_Type?>" border="0" style="cursor:pointer; color:#333333; text-decoration:none;" target="_blank"; title="IMEI :<?=$IMEI_Decode?>"> <?php } ?> <?=$Tower_Img? ></a><?= $Time?></td>
                                            <tr>
