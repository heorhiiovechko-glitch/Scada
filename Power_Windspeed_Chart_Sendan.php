...
//Getting All Hours Calculation
		...
		if($Format_Type==10 || $Format_Type==3 || $Format_Type==7 || $Format_Type==9  ){
			$GEN_Min_Value=0;
...
elseif($Format_Type==7)
{
	if($Database_Name=='va_sendan')
		$Filename="channel8_Sendan.php?c1=".$_REQUEST['c1']."&l=".$_REQUEST['l']."&FType=".$Format_Type;
	else
