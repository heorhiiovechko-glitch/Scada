...
error_reporting(0);
            ...
            <td width="100%">
                ...
                <table width="100%" border="<?=$XLS == 1?"1":"0"?>" align="left" cellpadding="1" cellspacing="1" class="innertab1">	
					...
					<tr>
						...
						<td class="tab-head-tr" colspan="4"  align="center"><b>Pitch Report&nbsp;-&nbsp; <?=$IMEI?> </b></td>
					...
					?>
						...
						<tr>
							...
							<td class="tab-head-tr" colspan="4" align="left">&nbsp;&nbsp;<b>Pitch</b></td>
	...
	$Raw_Data_Query="select Pitch,Date_S,Time_S from $Cook_Variable[7].$Table_Name where  IMEI = '".$IMEI."' and (Date_S >= '".$From_YMD."' and  Date_S <= '".$To_YMD."') order by Date_S desc, Time_S desc ";
            ...
            if($Mysql_Query_Result->num_rows >= 1)
            {
				?>
                    ...
                    <tr>
                             ...
                             <td class="tab-head-td" align="left"><b>Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</b></td> 
                             <td class="tab-head-td" align="left"><b>Time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
			     <td class="tab-head-td" align="left"><b>Pitch</b></td> 
