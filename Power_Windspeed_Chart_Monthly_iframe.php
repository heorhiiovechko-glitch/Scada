<?php
    ...
    if (isset($_REQUEST['c1'])) {
        ...
        // Fetch device info
        $Mysql_Query = "SELECT IMEI, Power_Curve, Format_Type, Device_Name , Db_name
        ...
        if (isset($IMEI)) {
			...
			elseif ($Power_Curve_Array[$IMEI] == 850) { $PCWP_Chart_Arr = $PCWP_Chart_Arr_850; }
        }
		...
		// $i = count($Each_Days_Generation_Arr);
		// echo "Each_Days_Generation_Arr.count : $i";
	    // echo "Each_Days_Generation_Arr[$i] : $Each_Days_Generation_Arr[$i]";
    }
?>
