...
.dashboard-report-link:hover{
    ...
    color:#075f4b;
    text-decoration:none;
    box-shadow:0 3px 9px rgba(15,117,92,.16);
...
<div style="display:flex; gap:10px; align-items:center; margin-top:10px; flex-wrap:wrap;">
    ...
    <div class="legend-item">
        <span class="chip blue"><img src="images/Blue_jpg.jpg" style="width:18px;height:18px" alt=""> Service</span>
    </div>
	
	 <div class="legend-item">
        <span class="chip pink"><img src="images/18.jpg" style="width:18px;height:18px" alt=""> Impact</span>
    </div>
