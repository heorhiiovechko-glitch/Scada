...
<table width="100%" border="<?=$XLS == 1?'1':'0'?>" align="left" cellpadding="1" cellspacing="1" class="innertab1">	
	...
	?>
					   ...
					   <tr>
							<td class="tab-head-td"  colspan="10"  align="left"><b>Site:</b><?= implode(",",array_unique($Site_Location)) ?></td></tr>
 ...
 <?php 
			...
			if ($XLS == 0){
					...
					<tr>
						...
						<td  class="tab-head-tr"  colspan="10" align="left">&nbsp;&nbsp;<b>Daily Generation Detail Report</b></td>
	...
	<?php
		...
		if($Cook_Variable[2] ==3 || $Cook_Variable[2] ==2)
			...
			$Device_Query="select Device_Name,Format_Type,hour(Closing_Time) as Closing_Time, Connect_Feeder,Site_Location,State,IMEI from device_register where Parent_ID=" .$Cook_Variable[6] ."  order by Device_Order";
		elseif($Cook_Variable[2] ==4)
			$Device_Query="select Device_Name,Format_Type,hour(Closing_Time) as Closing_Time, Connect_Feeder,Site_Location,State,IMEI from device_register where Account_ID='".$Account_ID."'  order by Device_Order";
		//echo $Device_Query;
...
if($Format[$IMEI_Val]=='1') {
	$Gen_Mysql_Query="select IMEI,Date_S,Gen1_Min,Gen1_Max,Run_Min,Run_Max,Gen1H_Min,Gen1H_Max,Line_Min,Line_Max,abs(Import_Min) as Import_Min,abs(Import_Max) as Import_Max from daily_data where IMEI in (".implode(",",$F1_IMEI).")  and (Date_S= '".$Date_Stamp."')";
							...
							while($Fetch_Result = mysql_fetch_array($Gen_Mysql_Query_Result)){
								...
								$BD_Hours[$Fetch_Result['IMEI']][$DATE_Val]=24-($GD_Hours[$Fetch_Result['IMEI']][$DATE_Val]+$Lull_Hours[$Fetch_Result['IMEI']][$DATE_Val]+$Run_Hours[$Fetch_Result['IMEI']][$DATE_Val]);							
...
?>
		...
		<table width="100%" border="<?=$XLS == 1?"1":"0"?>" align="left" cellpadding="1" cellspacing="1" class="innertab1">
			...
			<?php 
					...
					?>
										<tr>
						<td class="tab-head-tr" colspan="4"  align="center"><b></b></td>
					...
					?>
						...
						<tr>
							<td class="tab-head-tr" colspan="4" align="left">&nbsp;&nbsp;<b></b></td>
						</tr>
			...
			<tr>
                            <td class="tab-head-td" width="15px" align="left"><b>Device</b></td>                              
			<td class="tab-head-td" width="95px" align="left"><b>Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;</b></td> 
                             <td class="tab-head-td" width="70px" align="left"><b>Time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
			<td class="tab-head-td" width="15px" align="left"><b>Error</b></td>                              
  			     			     

                    </tr>

<?php
	$Mysql_Query_Error = "select IMEI,Date_S,Time_S,Status,Date,Time from $Cook_Variable[7].current_status where IMEI in (".implode(",",$DGR_IMEI).") and (Date_S >= '".$From_YMD."' and Date_S <= '".$To_YMD."') order by IMEI asc,Date_S asc,Time_S asc";
//echo $Mysql_Query_Error;
				...
				if($Mysql_Record_Error_Count>=1){
					...
					while($Fetch_Error_Result = mysql_fetch_array($Mysql_Query_Error_Result)){						
							$All_Error_Date_Arr[$Fetch_Error_Result['IMEI']] = $Fetch_Error_Result['Date_S'];
							$All_Error_Time_Arr[$Fetch_Error_Result['IMEI']] = $Fetch_Error_Result['Time_S'];
							$All_Error_Arr[$Fetch_Error_Result['IMEI']] = $Fetch_Error_Result['Status'];
								?>
								<tr>                       
			<td class="tab-head-td1" align="left"><?=$Device_Name[$Fetch_Error_Result['IMEI']]?></td> 						
                        <td class="tab-head-td1" align="left" width="20%"><?=$All_Error_Date_Arr[$Fetch_Error_Result['IMEI']]!=''?$All_Error_Date_Arr[$Fetch_Error_Result['IMEI']]:'0'?></td>                                    
                        <td class="tab-head-td1" align="left" width="20%"><?=$All_Error_Time_Arr[$Fetch_Error_Result['IMEI']]!=''?$All_Error_Time_Arr[$Fetch_Error_Result['IMEI']]:'0'?></td> 
			<td class="tab-head-td1" align="left"><?=$All_Error_Arr[$Fetch_Error_Result['IMEI']]!=''?$All_Error_Arr[$Fetch_Error_Result['IMEI']]:'0'?></td>  
                   </tr>
			<?php
				//$MI++;
					}
