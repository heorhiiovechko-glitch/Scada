...
error_reporting(0);
            ...
            <td width="100%">
                ...
                <table width="100%" border="<?=$XLS == 1?"1":"0"?>" align="left" cellpadding="1" cellspacing="1" class="innertab1">	
					...
					<tr>
						...
						<td class="tab-head-tr" colspan="4"  align="center"><b>GRPM Report&nbsp;-&nbsp; <?=$IMEI?> </b></td>
					...
					?>
						...
						<tr>
							...
							<td class="tab-head-tr" colspan="4" align="left">&nbsp;&nbsp;<b>GRPM</b></td>
	...
	$Raw_Data_Query="select GRPM,Date_S,Time_S from $Cook_Variable[7].$Table_Name where  IMEI = '".$IMEI."' and (Date_S >= '".$From_YMD."' and  Date_S <= '".$To_YMD."') order by Date_S desc, Time_S desc ";
if (!$Mysql_Query_Result = $db->query($Raw_Data_Query))
            ...
            ?>
			     ...
			     <td class="tab-head-td" align="left"><b>GRPM</b></td> 
