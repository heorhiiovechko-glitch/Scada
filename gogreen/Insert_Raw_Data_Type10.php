<?php
	...
	$Form_Fields[] = array('1','1','Pitch','Pitch','','','E|N|0','','txtbox','','');	
	...
	$Form_Fields[] = array('1','1','Hydraulic Temp','Hydraulic_Temp','','','E|N|0','','txtbox','','');
	...
	$Form_Fields[] = array('1','1','Control Temp','Control_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Bearing Temp','Bearing_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Total Hours','Total_Hours','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Run Hours','Run_Hours','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','PAT_Gen0','PAT_Gen0','','','E|N|0','','txtbox','','');	
	...
	$Form_Fields[] = array('1','1','Line Hours','Line_Hours','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Line Ok','Line_Ok','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Turbine Ok','Turbine_Ok','','','E|N|0','','txtbox','','');	
	...
	// Insert Query is Starting
		if($Record_Count == 0){
			if($Query_To_Mysql_Join == '')
				$Query_To_Mysql = "Insert into $db_name.device_data_f10 (".substr($Query_Left,0,-1).") values (".substr($Query_Right,0,-1).")";
			else
