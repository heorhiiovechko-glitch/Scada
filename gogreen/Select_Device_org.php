...
<table border="0" cellpadding="4" cellspacing="1">
                    <tr>
<?php
echo "<form  method=post action=\"Insert_Raw_Data.php\">";
while($Fetch_Result = mysql_fetch_array($Resultset)){
?>
<td><input type=hidden  name=Format_Type id=Format_Type value="<?=$Format_Type?>"></td><td><input type=hidden  name=db_name id=db_name value="<?=$db_name?>"></td><td><input type=hidden id=Date  name=Date value="<?=$Date?>"></td><td><input type=hidden  name=imei id=imei value="<?=$IMEI?>"></td><td><input type=hidden  name=Table_Name id=Table_Name value="<?=$Table_Name?>"></td>
</tr>
<?php
}
?>
