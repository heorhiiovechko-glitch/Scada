<?php
	...
	$Form_Fields[] = array('1','1','In Time(HH:MM:SS 24 Hr format)','In_Time','00:00:00','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Out Time(HH:MM:SS 24 Hr format)','Out_Time','23:59:59','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Database(va_Database name Format)','Db_Name','va_','*','E|N|0','','txtbox','','');
	...
	//$Form_Fields[] = array('1','7','In Time','In_Time','00:00:00','*','1','selectcls','','-----In Time-----','');
	//$Form_Fields[] = array('1','7','Out Time','Out_Time','23:59:59','*','1','selectcls','','-----Out Time-----','');
...
//mysql_insert_id();
//echo $Insert_ID;
$Select_Db_Query="select Db_Name from user_master where Account_ID='$Insert_ID'";
echo $Select_Db_Query;
$Select_Db_Query_Result = mysqli_query($db,$Select_Db_Query);
if (!$Select_Db_Query_Result)
            {
                 die("Connection failed: " . mysqli_connect_error());
            }

                $Select_Db_Query_Fetch_Result = mysqli_fetch_array($Select_Db_Query_Result);
					$Db_Name= $Select_Db_Query_Fetch_Result['Db_Name'];
//echo $Db_Name;
}
...
if ($db_selected){
echo $Db_Name;
$sql_file=$_SERVER['DOCUMENT_ROOT'].'\jayakrishna.sql';
echo $sql_file;
$cmd = "mysqli --host=$hostname --user=$username --password=$password -D $Db_Name <  $sql_file";
