<?php
	...
	//$List_Fields[] = array('Customer','Customer','','','');
	...
	if( (isset($_REQUEST[$Form_Fields[$Submit_Pos][3]])) || (isset($_REQUEST['SearchD'])) ){
		...
		if(isset($_REQUEST['search'])){
			...
			$Query_To_Mysql_Result = mysqli_query($Query_To_Mysql_Search);
...
?>			
                ...
                <?php
					...
					$Record_Column = 0;
					if($XLS == 1){
						$Result = mysqli_query($Select_Mysql);
				...
				<?php
					...
					while($Fetch_Result = mysqli_fetch_array($Result)){
						...
						echo $Display_List[] = "<tr class='$Row_Cls' height='25'>";
							...
							echo "<a href='List_User.php?P_ID=".$Fetch_Result['Account_ID']."&P_ID1=".$Fetch_Result['Parent_ID']."' title='Detail View'><img src='./images/detail_icon.gif' height='20px' width='20px' title='Detail View'></a>";  
							echo "</td>";
							echo "</tr>";
