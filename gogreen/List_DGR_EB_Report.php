<?php
	...
	$List_Fields[] = array('Update Date','Date_Stamp','','','');
...
?>			
				...
				<?php
					...
					while($Fetch_Result = mysql_fetch_array($Result)){
						...
						$IMEI = $Fetch_Result['IMEI'];
						echo "<form name='Form_".$Record_Column."' action='Update_EB_Reading.php'>";
						echo $Display_List[] = "<tr class='$Row_Cls' height='25'>";
							...
							foreach($List_Fields as $Fields){
									...
									elseif($Fields[0] == 'Update Date'){
										echo "<td class='Row_Td'>";
											$Encode_IMEI = base64_encode($Fetch_Result['IMEI']);
											?>
											<input type='text' name='Date' id='Date' class='txtbox' style='width:60px' value="<?=date("d-m-Y")?>">
											<input type='hidden' name='Edit' id='Edit' class='txtbox' style='width:60px' value="<?=base64_encode($IMEI)?>">
											<?php
										echo "</td>";
									}
									elseif($Fields[0] == 'Option'){
										echo "<td class='Row_Td'>";
											$Encode_IMEI = base64_encode($Fetch_Result['IMEI']);
											$Device_Status_Url = "./Update_EB_Reading.php?Edit=".$Encode_IMEI."";
											echo '<input type="submit" name="EBU" id="EBU" value="Update">';
										echo "</td>";
									}
							}								
