...
.submit-area{
    margin-top:30px;
    padding-top:20px;
    border-top:1px solid #e5eaf2; /* subtle separator */
    text-align:center;
...
input[type=submit]{
    ...
    line-height:48px;         /* ✅ vertical center (important) */

    padding:0;                /* remove imbalance */
}
...
<form method="post" name="<?=$Title_Head?>" 
...
<div class="field-label"><?= $Forms[2] ?></div>
