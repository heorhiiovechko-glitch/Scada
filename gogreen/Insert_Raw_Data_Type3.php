<?php
	...
	$Form_Fields[] = array('1','1','Message ID','Message_ID','WTWMD','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','IMEI','IMEI',$IMEI,'','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date F','Date_F','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Time F','Time_F','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Project Version','Project_Version','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','ID Number','ID_Number','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','GRPM','GRPM','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','RRPM','RRPM','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Windspeed','Windspeed','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Status','Status','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date','Date','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Time','Time','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Power Factor','Power_Factor','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Power','Power','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Reactive Power','Reactive_Power','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','RPhase Volt','RPhase_Volt','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','YPhase Volt','YPhase_Volt','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','BPhase Volt','BPhase_Volt','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','RPhase Current','RPhase_Current','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','YPhase Current','YPhase_Current','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','BPhase Current','BPhase_Current','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Frequency','Frequency','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Total Hours','Total_Hours','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Production Total','Production_Total','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','PAT Gen1','PAT_Gen1','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','PAT_Gen2','PAT_Gen2','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen1 Hours','Gen1_Hours','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen2 Hours','Gen2_Hours','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Hydraulic Pressure','Hydraulic_Pressure','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Nacelle Position','Nacelle_Position','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Thyristor Temp','Thyristor_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Ambient Temp','Ambient_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Main Panel Temp','Main_Panel_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen1 Temp','Gen1_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen2 Temp','Gen2_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Bearing Temp','Bearing_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gear Temp','Gear_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Nacel Temp','Nacel_Temp','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Temp9','Temp9','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Temp10','Temp10','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Import Kwh','Import_Kwh','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Import_Kvarh','Import_Kvarh','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','YAW CW Counts','YAW_CW_Counts','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','YAW CCW Counts','YAW_CCW_Counts','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy1','Dummy1','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy2','Dummy2','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy3','Dummy3','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy4','Dummy4','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy5','Dummy5','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy6','Dummy6','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy7','Dummy7','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy8','Dummy8','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy9','Dummy9','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy10','Dummy10','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','CPCM','CPCM','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Dummy11','Dummy11','NULL','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date(Server)','Date_S',$Date,'','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Time(Server)','Time_S','','','E|N|0','','txtbox','','');
	//$Form_Fields[] = array('1','5','',$Submit_Txt,'Insert Raw Data','','','','submit_but','');
	...
	// Insert Query is Starting
		if($Record_Count == 0){
			if($Query_To_Mysql_Join == '')
				$Query_To_Mysql = "Insert into $db_name.device_data_f6 (".substr($Query_Left,0,-1).") values (".substr($Query_Right,0,-1).")";
			else
				$Query_To_Mysql = $Query_To_Mysql_Join;	
	echo $Query_To_Mysql;
				$Query_To_Mysql_Result = mysqli_query($db,$Query_To_Mysql);
				...
				if($Query_To_Mysql_Result){
					...
					$message1=urldecode($Msg);
					echo $message1;
					echo $Query_To_Mysql;
					$Title_Head1 = str_replace('_',' ',$Title_Head);
					//Update_Query_Executer($Cook_Variable[1],''.$Title_Head1.' <b>'.$_REQUEST['Edit'].'</b> Added Successfully');
					header("Location:Select_Device.php?msg=$message1");
					exit;
				}
