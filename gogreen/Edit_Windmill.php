<?php
	...
	$Form_Fields[] = array('1','1','Name','Device_Name','','','E|N|0','','txtbox','','');$Form_Fields[] = array('1','1','Reset Password','db_name1','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Closing Time','Closing_Time','','','E|N|0','','txtbox','','');	
	...
	$Form_Fields[] = array('1','1','WEG_No','WEG_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Connect_Feeder','Connect_Feeder','','','E|N|0','','txtbox','','');
	...
	//$Form_Fields[] = array('2','2','Contract Status','Contract_Status',$Contract_Status_Array,'*','1','selectcls','','-----Contract Status-----','');
	$Form_Fields[] = array('1','1','Date of Commission','Date_Of_Commission','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('2','2','Device Order','Device_Order',$day_array,'*','1','selectcls','','-----Device Order-----','');
	...
	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'Update Device','','','','submit_but','');
	...
	if(isset($_REQUEST[$Form_Fields[$Submit_Pos][3]])){
		...
		if($Record_Count == 0){
				echo $Query_To_Mysql = "Update $Table_Name set ".substr($Query_For_Update,0,-1)." where ".$Edit_Column." = '".$Edit_Record."'";
				$Query_To_Mysql_Result = mysqli_query($db,$Query_To_Mysql);
				
				if(!$Query_To_Mysql_Result){
					echo $Err_Msg = Message_Display("Mysql Error :");
					echo $Err_Msg = "<div class='error_text1'>".mysqli_error()."</div>";
				}
				if($Query_To_Mysql_Result){
