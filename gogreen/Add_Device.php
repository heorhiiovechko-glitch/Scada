...
error_reporting(E_ALL);
 ini_set('display_errors', 1);	
	...
	$Duplicate_Column = "";
	$Databasename_Query = "select Db_Name from user_master where Account_ID='".$_REQUEST['P_ID']."'";
		$Databasename_Query_Result = mysqli_query($db,$Databasename_Query) or die(mysqli_connect_error());
		$Databasename_Record_Count = mysqli_num_rows($Databasename_Query_Result);
		$Databasename_Fetch_Result = mysqli_fetch_array($Databasename_Query_Result);
				$Db_Name_User = $Databasename_Fetch_Result['Db_Name'];
			
		echo $Db_Name_User;

	//Text boxes
		$Form_Fields[] = array('1','1','IMEI','IMEI','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','UID','UID','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','SIM No','SIM_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','HTSC No','HTSC_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Name','Device_Name','','','E|N|0','','txtbox','','');	
	//$Form_Fields[] = array('1','1','Phone No','Phone_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('2','2','Format Type','Format_Type',$Data_Format_Array,'*','1','selectcls','','-----Format Type-----','');
	$Form_Fields[] = array('2','2','Pocket Length','Pocket_Length',$Data_PocketLength_Array,'*','1','selectcls','','-----Pocket length-----','');
	$Form_Fields[] = array('2','2','Power KW','Power_Curve',$Power_Curve_Array,'*','1','selectcls','','-----Power Curve-----','');
	$Form_Fields[] = array('1','1','LOC No','LOC_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','WEG No','WEG_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Connect Feeder','Connect_Feeder','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','SF Number','SF_No','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Site Location','Site_Location','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Region','Region','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','GPS Latitude','GPS_Latitude','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','GPS Longitude','GPS_Longitude','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('2','2','State','State',$State_Array,'*','1','selectcls','','-----State-----','');
	//$Form_Fields[] = array('1','1','DOC','DOC','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Capacity','Capacity','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Order','Device_Order','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date of Commission','Date_Of_Commission','','','E|N|0','','txtbox','','');

	//Select
	//$Form_Fields[] = array('2','2','Status','Status',$Status_Array,'*','1','selectcls','','-----Status-----','');

	$Form_Fields[] = array('1','7','Date_Stamp','Date_Stamp',date("Y-m-d H:i:s"),'*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','7','Account_ID','Account_ID',$_REQUEST['P_ID'],'*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','7','Parent_ID','Parent_ID',$_REQUEST['P_ID1'],'*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','7','db_name','db_name',$Db_Name_User,'*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','7','db_name1','db_name1',$Db_Name_User,'*','E|N|0','','txtbox','','');
    $Form_Fields[] = array('1','1','Phone No 1','Phone_No_1','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone No 2','Phone_No_2','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone No 3','Phone_No_3','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone No 4','Phone_No_4','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone No 5','Phone_No_5','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone No 6','Phone_No_6','','','E|N|0','','txtbox','','');
        
	
	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'Add Device','','','','submit_but','');
		...
		if($Record_Count == 0){
			if($Query_To_Mysql_Join == '')
				...
				if(!$Query_To_Mysql_Result){
					echo $Err_Msg = Message_Display("Mysql Error : ".mysqli_connect_error());
					echo $Err_Msg = "<div class='error_text1'>".mysqli_connect_error()."</div>";
				}
				// Files and Photo Upload
				if($Query_To_Mysql_Result){
exec("php csvfile.php 2> errors.txt");
