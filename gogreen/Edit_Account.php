<?php
	...
	//Select
	$Form_Fields[] = array('2','2','User Type','User_Type_ID',$User_Type_Array,'*','1','selectcls','','-----User Type-----','');
	...
	// Hidden
	$Form_Fields[] = array('1','7','Account Valid Upto','Valid_Till',date("Y-m-d"),'','E|N|0','','txtbox','','');
