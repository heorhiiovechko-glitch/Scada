<?php
	...
	$Order_By = "Record_Index asc"; // Column name to be order and which order (asc or desc)
	$Records_Per_Page = 100;
	$Pagination_No_Count = 10;
	$Edit_ID_Column = "ID"; // Unique value should be give for whatever query you do in that table
	...
	$Search_Fields = array('Error');

	//List Fields
	$List_Fields[] = array('Error Message','Error','','','');
	$List_Fields[] = array('Sample RawData','Raw_Data','','','');
	$List_Fields[] = array('IMEI','IMEI','','','');
	/*$List_Fields[] = array('Checkbox','Chec','','','');
	$List_Fields[] = array('Hidden','Hid','','1','');
	$List_Fields[] = array('Textarea','Texta','20','','');
	$List_Fields[] = array('Select','Sel','','',$Status_Array);
	$List_Fields[] = array('Gender','Gender','','',$Gender_Array);
	*/
