<?php
	...
	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'Update Error','','','','submit_but','');
	...
	if(isset($_REQUEST[$Form_Fields[$Submit_Pos][3]])){
		...
		foreach($Form_Fields as $Forms){
			...
			if($Forms[1] != 5 && $Forms[1] != 6 && $Forms[1] != 8){
				...
				if($Forms[1] == 9){
					$_REQUEST[$Forms[3]] = "<pre>".$_REQUEST[$Forms[3]]."</pre>";
				}else{
					$_REQUEST[$Forms[3]] = $_REQUEST[$Forms[3]];
				}
					...
					<div id="admin_left_inner">
                           ...
                           <?
                            ...
                            ?>
                            				<?
                            					if($Forms[1] == 9){
													$Get_Record[$Forms[3]] = str_replace('<pre>','',$Get_Record[$Forms[3]]);
													$Get_Record[$Forms[3]] = str_replace('</pre>','',$Get_Record[$Forms[3]]);
												}else{
													$Get_Record[$Forms[3]] = $Get_Record[$Forms[3]];
												}
											?>
