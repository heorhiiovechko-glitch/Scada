<?php
	...
	$Order_By = "User_Type_ID asc"; // Column name to be order and which order (asc or desc)
	$Records_Per_Page = 20;
	$Pagination_No_Count = 2;
	$Edit_ID_Column = "User_Type_ID"; // Unique value should be give for whatever query you do in that table
	...
	$Search_Fields = array('User_Type_ID','User_Type','User_Type_Description');

	//List Fields
	$List_Fields[] = array('User Type ID','User_Type_ID','','','');
	$List_Fields[] = array('User Type','User_Type','','','');
	$List_Fields[] = array('Description','User_Type_Description','','','');
