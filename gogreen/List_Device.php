								...
								<tr><br />
                                    ...
                                    <td valign="middle">
										...
										<?			
										   ...
										   <input type="hidden" name="P_ID1" id="P_ID1" value="<?=$_REQUEST['P_ID1']?>" />
                                           </td>
                                           </tr>
                                           </table>
                                        </td>   
                	...
                	<td align="center">
                        <table border="0" cellpadding="3" cellspacing="1" width="980" height="40px" align="left" class="info_tab">
                            <tr>
                                ...
                                <td width="80px;" align="center" class="info_tb"><a href="List_User.php?P_ID=<?=$P_ID?>&P_ID1=<?=$P_ID1?>">List User</a></td>
                                ...
                                <?
									...
									echo "<a href='List_User.php?P_ID=".$_REQUEST['P_ID']."&P_ID1=".$_REQUEST['P_ID1']."' title='Detail View'><img src='./images/detail_icon.gif' height='20px' width='20px' title='Detail View'></a>";
...
?>			
				...
				echo $_REQUEST['U_ID'];
					...
					if($Query_To_Mysql_Search)
						...
						elseif($utid=='3')
						$Select_Mysql = "SELECT $Edit_Column $Mysql_Select_Column FROM $Table_Name where Parent_ID = '".$_REQUEST['P_ID1']."' order by $Order_By";	
		//echo $utid;
		//echo $Select_Mysql;
					...
					if($XLS == 1){
						...
						while($Fetch_Result = mysqli_fetch_array($Result)){
							...
							foreach($List_Fields as $Fields){
									...
									elseif($Fields[0] == 'UID'){
										echo "<td class='Row_Td' align='left'>";
											echo "&nbsp;".$Fetch_Result['UID'];
										echo "</td>";
									}
									elseif($Fields[0] == 'Status'){
										echo "<td class='Row_Td' align='left'>";
											echo $Status_Array[$Fetch_Result['Status']];
										echo "</td>";
									}
					...
					while($Fetch_Result = mysqli_fetch_array($Result)){
						...
						echo $Display_List[] = "<tr class='$Row_Cls' height='25'>";
							...
							foreach($List_Fields as $Fields){
									...
									elseif($Fields[0] == 'Wtsys File'){
									echo "<td class='Row_Td'>";
											echo $View_Link1 = "<table><tr>";
											if(file_exists($Check_C)){
												echo "<td><a href='".$WTSYS_Logs_File_Path_Link."/".$File_C."' title=\"View Today Log Information\" target=\"_New\" $class>T</a>&nbsp;&nbsp;|&nbsp;&nbsp;</td>";
											}	
											if(file_exists($Check_Y)){
												echo "<td><a href='".$WTSYS_Logs_File_Path_Link."/".$File_Y."' title=\"View Yesterday Log Information\" target=\"_New\" $class>Y</a>&nbsp;&nbsp;|&nbsp;&nbsp;</td>";
											}
											if(file_exists($Check_DBY)){
												echo "<td><a href='".$WTSYS_Logs_File_Path_Link."/".$File_DBY."' title=\"View Day Before Yesterday Log Information\" target=\"_New\" $class>DY</a></td>";
											}
											echo "</tr></table>";
									echo "</td>";	
									}
