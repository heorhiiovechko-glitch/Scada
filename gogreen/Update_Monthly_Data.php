<?php
	...
	if(isset($_REQUEST[$Form_Fields[$Submit_Pos][3]])){
		...
		if($Record_Count == 0){
				echo $Query_To_Mysql = "Update va_master.monthly_data set ".substr($Query_For_Update,0,-1)." where IMEI = '".$IMEI."' and Month='".$Month."' and Year='".$Year."'";
				...
				if($Query_To_Mysql_Result){
					...
					header("Location:Select_Device_Monthly.php?msg=$Msg");
					exit;
				}
		}
	}
...
<?php
		...
		$Select_Query = "select * from va_master.monthly_data where IMEI = '".$IMEI."' and Month='".$Month."' and Year='".$Year."'";
