...
<div class="gblNavigation" id="gblNavigation" style="border:solid 0px red;">
	...
	<?php
		...
		$Menus_Array = array ('Accounts','Device','Data From Device');
		$Sub_Menus_Array = array ('E','AL','E');
		...
		$Extra_Menu_Array[2] = array (
									...
									2 => array("-","Raw_Data.php | Raw DATA"),
									3 => array("-","Invalid_Data.php | Invalid DATA")
									//4 => array("-","List_Daily_Logs.php| Daily Logs")
								);
