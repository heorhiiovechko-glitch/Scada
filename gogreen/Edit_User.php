<?php
	...
	//Text boxes
	$Form_Fields[] = array('1','1','Account ID','Account_ID','','*','E|N|0','readonly=readonly style="background-color:#f5f5f5; font-weight:bold;"','txtbox','','');
	...
	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'Update User','','','','submit_but','');
