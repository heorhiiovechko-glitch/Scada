<?php
	...
	$Form_Fields[] = array('1','1','Start Pocket','Start_Pocket','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Pocket Length','Pocket_Length','','*','E|N|0','','txtbox','','');
	...
	$Form_Fields[] = array('1','1','Connecting Feeder','Connect_Feeder','','*','E|N|0','','txtbox','','');
...
<?php 
		$Title_Head_alter = 'Device Details';
		echo "<form action=\"\" method=\"post\" name=\"".$Title_Head."\" onsubmit=\"return FormValid('$Jvalid_Arr_Join','$Jvalid_Type_Arr_Join')\" enctype=\"multipart/form-data\" >";
				...
				echo '<div id="admin_left" style="width:990px; border:solid 0px red;">
							<p class="headings" style="padding-left:10px;">'.$Title_Head_alter.'</p>
							<p>&nbsp;</p>';
					...
					<div id="admin_left_inner">
                           ...
                           <?
                            ...
                            ?>
										...
										<? 
											if($Forms[3] == 'Format_Type')
												echo '<br /><p class="headings" style="margin-left:-30px;">Wind Machine Details</p><br />';
										?>
