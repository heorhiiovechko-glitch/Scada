<?php
	...
	$Form_Fields[] = array('1','1','Address','Address','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Site','Site','','*','E|N|0','','txtbox','','');
	...
	//$Form_Fields[] = array('1','1','Date of Communication','Communi_Date','','*','E|N|0','','txtbox','cal','');
	...
	//Select
	$Form_Fields[] = array('1','7','User Type','User_Type_ID','3','*','1','selectcls','','-----User Type-----','');


	//Select
	$Form_Fields[] = array('1','7','Admin Access','GPSAdmin','Enabled','*','1','selectcls','','----- Admin Access-----','');
