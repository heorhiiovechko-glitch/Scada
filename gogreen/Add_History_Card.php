<?php
	...
	if(empty($_COOKIE[$Cook_Name])){
		...
		# Getting IMEI
		$Mysql_Query = "select * from DEVICE_REGISTER";
	...
	$Table_Name = "HISTORY_CARD";
	$Duplicate_Column = "";
	
	//Text boxes
	$Form_Fields[] = array('2','2','IMEI','IMEI',$ALLIMEI_Array,'*','1','selectcls','','----- Select IMEI-----','');
	$Form_Fields[] = array('1','1','Name of the Customer','H1','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Capacity','H2','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Location','H3','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Survery Number','H4','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Type of WTG','H5','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date of commisioning','H6','','','E|N|0','','txtbox','Cal','');
	$Form_Fields[] = array('1','1','E.B. - H.T. - S.C. No.','H7','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Guarantee period','H8','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Expiry date','H9','','*','E|N|0','','txtbox','Cal','');
	$Form_Fields[] = array('1','1','Energy meter Make & Sl.No.','H10','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','SS & Feeder','H11','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Make','H12','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Capacity','H13','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Serial number','H14','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Connection','H15','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Transformation Ratio','H16','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','CTPT Make & Sl.No.','H17','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Make','H18','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Capacity','H19','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Serial number','H20','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Connection','H21','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Make','H22','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Serial number','H23','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Ratio','H24','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Oil quantity(in Ltrs.)','H25','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Yaw motor make& Sl. No.','H26','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Hub motor make & Sl. No.','H27','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Blade make & Sl. No.','H28','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Extender Make & Sl.No.','H29','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Hub make & Sl.No','H30','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Bed Frame Make & Sl.No.','H31','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Brake System Make','H32','','','E|N|0','','txtbox','','');
	
	$Form_Fields[] = array('1','1','Control Panel Sl. No.','H33','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','capacitor panel Sl. No.','H34','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Power Panel Sl. No.','H35','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Nacelle SL.NO','H36','','','E|N|0','','txtbox','','');

	$Form_Fields[] = array('1','7','Date Stamp','Date_Stamp',date("Y-m-d H:i:s"),'','E|N|0','','txtbox','','');

	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'New History Card','','','','submit_but','');
		...
		if($Record_Count == 0){
			if($Query_To_Mysql_Join == '')
				...
				if($Query_To_Mysql_Result){
					...
					header("Location:List_Super_Admin_Accounts.php?msg=$Msg");
					exit;
				}
		}
	}
