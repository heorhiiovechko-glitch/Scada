<?php
	...
	//$Form_Fields[] = array('1','1','Update Date Stamp','Update_Date_Stamp',$Cur_Date,'','E|N|0','','txtbox','','');

	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'Update History Card','','','','submit_but','');
					...
					<div id="admin_left_inner">
                           ...
                           <?
                            ...
                            ?>
                                        ...
                                        <?
											if($Forms[3] == 'Password')
												echo "<span class='date_format'>( ".$Get_Record[$Forms[3]]." )</span>";
										?>
                                        <?=J_Mes($Forms[3]);?>
