...
<div class="gblNavigation" id="gblNavigation" style="border:solid 0px red;">
	...
	<?php
		...
		$Menus_Array = array ('Customers','Windmill Status & Logs','User Preference');
		...
		$Extra_Menu_Array[0] = array (
									0 => array("List_Admin_Accounts.php | List Customers","-")
								);

		$Extra_Menu_Array[1] = array (
									0 => array("List_Windmill_Status.php | Windmill Status","List_Daily_Logs.php | Daily Logs")
								);
