<?php
	...
	$List_Fields[] = array('Customer','Account_ID','','','');
	$List_Fields[] = array('IMEI','IMEI','','','');
	$List_Fields[] = array('Format','Format_Type','','',$Data_Format_Array);
	$List_Fields[] = array('HTSC No','HTSC_No','','','');
	$List_Fields[] = array('Pocket Length','Pocket_Length','','','');
	$List_Fields[] = array('Device Order','Device_Order','','','');
	$List_Fields[] = array('Status','Status','','',$Status_Array);
	$List_Fields[] = array('Option','IMEI','','','');
	$List_Fields[] = array('Log File','IMEI','','','');
...
$Db_Name_Column = $Db_Column.",";
					...
					if($Query_To_Mysql_Search)
						...
						$Select_Mysql = "SELECT $Edit_Column $Db_Name_Column $Mysql_Select_Column FROM $Table_Name";
	...
	###########################################################################
						...
						if($ED_Mysql_Record_Count>=1){
							...
							$ED_Error_Array[$ED_Fetch_Result['IMEI']] = $ED_Fetch_Result['Error'];
...
$ED_Device_Epoch_Time_Array[$ED_Fetch_Result['IMEI']] = GetTimestamp($ED_Error_Date[$ED_Fetch_Result['IMEI']],$ED_Error_Time[$ED_Fetch_Result['IMEI']]); 
						...
						if($Mysql_Record_Count1 >= 0){
							$Fetch_Result1 = mysql_fetch_array($Mysql_Query_Result1); 											
	...
	#############################################
							...
							foreach($List_Fields as $Fields){
									...
									echo "<td class='Row_Td'>";
										echo date("d-M-Y",strtotime($Fetch_Result['Date_Stamp']));
										echo "</td>";
									}
									elseif($Fields[0] == 'Customer'){
										echo "<td class='Row_Td' align='left'>";
											echo $Username_Array[$Fetch_Result['Account_ID']];
										echo "</td>";
									}
									elseif($Fields[0] == 'IMEI'){
										echo "<td class='Row_Td'>";
											echo $Fetch_Result['IMEI'];
										echo "</td>";
									}
									elseif($Fields[0] == 'Format'){
										echo "<td class='Row_Td'>";
											echo $Data_Format_Array[$Fetch_Result['Format_Type']];
										echo "</td>";
									}
									elseif($Fields[0] == 'HTSC No'){
										echo "<td class='Row_Td'>";
											echo $Fetch_Result['HTSC_No'];
										echo "</td>";
									}
									elseif($Fields[0] == 'Status'){
										echo "<td class='$Device_Status_Class'>";
											//echo $Tower_Img;
										echo "</td>";
									}
									elseif($Fields[0] == 'LOC No'){
										echo "<td class='Row_Td'>";
											echo $Fetch_Result['LOC_No'];
										echo "</td>";
									}
							}								
								echo "</tr>";
	...
	#############################################
						...
						echo $Display_List[] = "<tr class='$Row_Cls' height='25'>";
							...
							foreach($List_Fields as $Fields){
									...
									elseif($Fields[0] == 'Customer'){
										echo "<td class='Row_Td' align='left' title='".$Password_Array[$Fetch_Result['Account_ID']]."'>";
											echo $Username_Array[$Fetch_Result['Account_ID']];
										echo "</td>";
									}
									elseif($Fields[0] == 'IMEI'){
									...
									elseif($Fields[0] == 'Pocket Length'){
										echo "<td class='Row_Td'>";
											echo $Fetch_Result['Pocket_Length'];
										echo "</td>";
									}
									elseif($Fields[0] == 'Device Order'){
										echo "<td class='Row_Td'>";
											echo $Fetch_Result['Device_Order'];
										echo "</td>";
									}
									elseif($Fields[0] == 'Status'){
										echo "<td class='$Device_Status_Class'>";
									...
									elseif($Fields[0] == 'Option'){
										echo "<td class='Row_Td'>";
											$Device_Status_Url = "./List_User.php?P_ID=".$Fetch_Result['Account_ID']."";
											echo '<a href="'.$Device_Status_Url.'" title="Sort" class="Device_Detail_Link">Detail Info</a>';
										echo "</td>";
									}
									elseif($Fields[0] == 'Log File'){
										echo "<td class='Row_Td'>";
											$Day_Before_Yesterday = date("dmY",strtotime("-2 days"));	
											$Yesterday= date("dmY",strtotime("-1 days"));	
											$Current_Day = date("dmY");	
											
											$File_pa = $WTWMD_Logs_File_Path;
											$File_DBY = $Fetch_Result['IMEI']."_".$Day_Before_Yesterday.".txt";
											$Check_DBY = $File_pa."/".$File_DBY;
											$File_Y = $Fetch_Result['IMEI']."_".$Yesterday.".txt";
											$Check_Y = $File_pa."/".$File_Y;
											$File_C = $Fetch_Result['IMEI']."_".$Current_Day.".txt";
											$Check_C = $File_pa."/".$File_C;

											echo $View_Link = "<table><tr>";
											if(file_exists($Check_C)){
												echo "<td><a href='".$WTWMD_Logs_File_Path_Link."/".$File_C."' title=\"View Today Log Information\" target=\"_New\" $class>T</a>&nbsp;&nbsp;|&nbsp;&nbsp;</td>";
											}	
											if(file_exists($Check_Y)){
												echo "<td><a href='".$WTWMD_Logs_File_Path_Link."/".$File_Y."' title=\"View Yesterday Log Information\" target=\"_New\" $class>Y</a>&nbsp;&nbsp;|&nbsp;&nbsp;</td>";
											}
											if(file_exists($Check_DBY)){
												echo "<td><a href='".$WTWMD_Logs_File_Path_Link."/".$File_DBY."' title=\"View Day Before Yesterday Log Information\" target=\"_New\" $class>DY</a></td>";
											}
											echo "</tr></table>";
										echo "</td>";
									}
							...
							//echo "<td class='Row_Td' width='20px'><a href='Locate_Device.php?IMEI=".$Fetch_Result['IMEI']."' target='_New'><img src='./images/track.gif' /></a></td>";	-- hide by saranya
							echo "</tr>";
