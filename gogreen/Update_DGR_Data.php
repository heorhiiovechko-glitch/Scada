<?php
	...
	$Form_Fields[] = array('1','1','Gen1 Min','Gen1_Min','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','Gen1 Max','Gen1_Max','','','E|N|0','','txtbox','','');	
	$Form_Fields[] = array('1','1','Gen2 Min','Gen2_Min','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen2 Max','Gen2_Max','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Run Min','Run_Min','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Run Max','Run_Max','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen1H Min','Gen1H_Min','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen1H Max','Gen1H_Max','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen2H Min','Gen2H_Min','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Gen2H Max','Gen2H_Max','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Line Min','Line_Min','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Line Max','Line_Max','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Import Min','Import_Min','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Import Max','Import_Max','','','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date(Server)','Date_S','','','E|N|0','','txtbox','','');
	    
	
	//Submit Button
	$Form_Fields[] = array('1','5','',$Submit_Txt,'Update Data','','','','submit_but','');
	...
	if(isset($_REQUEST[$Form_Fields[$Submit_Pos][3]])){
		...
		if($Record_Count == 0){
				echo $Query_To_Mysql = "Update va_master.daily_data set ".substr($Query_For_Update,0,-1)." where IMEI = '".$IMEI."' and Date_S='".$Date."'";
				...
				if($Query_To_Mysql_Result){
					...
					Update_Query_Executer($Cook_Variable[1],''.$Title_Head1.' <b>'.$_REQUEST['IMEI'].'</b> Updated Successfully');
					header("Location:Select_Device_DGR.php?msg=$Msg");
					exit;
				}
		}
	}
...
<?php
		...
		$Select_Query = "select * from va_master.daily_data where IMEI = '".$IMEI."' and Date_S='".$Date."'";
